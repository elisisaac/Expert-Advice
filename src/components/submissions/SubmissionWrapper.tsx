    ...
    return (
        <div className="flex flex-col p-2 gap-8 overflow-hidden">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 shrink-0">
                {/* Title and Subtitle */}
                <div>
                    <h1 className="text-3xl font-bold bg-clip-text text-transparent bg-linear-to-r from-white to-gray-500">Submissions</h1>
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 w-full sm:w-auto">
                    <div className="relative w-full sm:w-64">
                        ...
                        <Input
                            ...
                            className="h-10 bg-white/5 border border-white/10 rounded-lg pl-10 pr-4 text-sm focus:outline-none focus:border-indigo-500/50 transition-colors placeholder:text-gray-600 text-white w-full"
                        />
                    </div>
